...
import { updateTask, fetchPriorityTasks, deleteTaskById  } from '../services/api';
...
export const PriorityTasks: React.FC = () => {
    ...
    const fetchTasks = async () => {
      try {
        const fetchedTasks = await fetchPriorityTasks(userId); // Use the fetchTasksByGoalId function
